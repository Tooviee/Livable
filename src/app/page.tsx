    ...
    <div className="min-h-screen flex flex-col">
      <header className="border-b border-stone-200 dark:border-stone-800">
        <div className="max-w-3xl mx-auto px-4 py-6 flex items-center justify-between">
          ...
          <nav className="flex gap-6">
            <Link
              href="/request"
              className="text-stone-600 hover:text-emerald-600 dark:text-stone-400 dark:hover:text-emerald-400 transition-colors"
            >
              Request help
            </Link>
            <Link
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-20">
        <div className="max-w-2xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight text-stone-900 dark:text-stone-100 mb-4">
            Help for foreigners
            <br />
            <span className="text-emerald-600 dark:text-emerald-400">living in Korea</span>
          </h1>
          ...
          <Link
            href="/request"
            className="inline-flex items-center justify-center rounded-lg bg-emerald-500 hover:bg-emerald-400 text-white font-medium px-6 py-3 transition-colors"
          >
            Submit a request
          </Link>
        </div>
        ...
        <section className="max-w-2xl mx-auto mt-24 grid sm:grid-cols-2 gap-6 text-left">
          <div className="rounded-xl border border-stone-200 bg-stone-50 dark:border-stone-800 dark:bg-stone-900/50 p-6">
            <h2 className="font-medium text-stone-800 dark:text-stone-200 mb-2">How it works</h2>
          ...
          <div className="rounded-xl border border-stone-200 bg-stone-50 dark:border-stone-800 dark:bg-stone-900/50 p-6">
            <h2 className="font-medium text-stone-800 dark:text-stone-200 mb-2">What we can help with</h2>
            <p className="text-stone-600 dark:text-stone-500 text-sm">
