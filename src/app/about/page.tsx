  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-12">
        <h1 className="text-2xl font-semibold text-stone-900 dark:text-stone-100 mb-8">About</h1>

        <div className="space-y-6">
          <p className="text-stone-700 dark:text-stone-200 leading-relaxed">{ABOUT.statement}</p>
          <div className="rounded-lg border border-stone-200 bg-stone-50 dark:border-stone-700 dark:bg-stone-900/50 p-4">
            <p className="text-stone-600 dark:text-stone-300 text-sm leading-relaxed">
              <strong className="text-stone-800 dark:text-stone-200">Your data is protected.</strong>{" "}
              {ABOUT.privacy}
            </p>
          </div>
          {ABOUT.instagramUrl ? (
      ...
      <footer className="border-t border-stone-200 dark:border-stone-800 py-6 mt-12 px-4">
        <div className="max-w-3xl mx-auto grid grid-cols-[1fr_auto_1fr] gap-4 items-center">
          ...
          <div className="text-right text-stone-600 dark:text-stone-400 text-sm">
            Contact us:{" "}
            <a
