              ...
              <div className="min-w-0 pl-6 space-y-4 border-l-2 border-emerald-200 dark:border-emerald-800 ml-1">
                <div className="min-w-0 overflow-hidden">
                  ...
                  <input
                    ...
                    className="block w-full min-w-0 rounded border border-stone-300 bg-white dark:border-stone-600 dark:bg-stone-900 px-3 py-2 text-sm text-stone-900 dark:text-stone-100 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 box-border"
                  />
                </div>
                <div>
